...
public class ManualDrive extends CommandBase {
    ...
    public void execute() {
        ...
        // Found Joystick ws drifing in rotation axis, added larger deadband so robot doesn't trurn without command
        r = (Math.abs(r) <= threshold) ? 0 : r;
        m_drivetrain.setDrive(y, x, r * 0.5, true); //Not robot oriented drive, fieldA oriented
    }
